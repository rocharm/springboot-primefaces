 ...
 * @since 1.0 
 */
public class Mensagem implements MessageSourceAware {
	...
	public void setMessageSource(MessageSource messageSource) {
		Mensagem.messageSource = messageSource;
	}
	...
	public static void setMessageCustom(FacesMessage message) {		
		FacesContext.getCurrentInstance().addMessage(null, message);
    }
	...
	public static String getMessage(String key) {
		...
		try {
			...
			msg = messageSource.getMessage(key, null, Locale.US);
	...
	public static void setCustomMessage(String mensagem, Severity severityError) {
		FacesMessage message = new FacesMessage(severityError, mensagem, mensagem);
		FacesContext.getCurrentInstance().addMessage(null, message);
	}	
